        ...
        <script type="text/javascript" language="javascript1.1">
           ...
           /*var browserName=navigator.appName; 
				...
				if (version=="n3")
				  ...
				  alert("<caption>College users only</caption>You need an upgrade, I think.");*/
        ...
        <div id="wrap">
            ...
            <div id="indexmain">
                <div align="center">  
                    ...
                    <form name="frmadminlogin" action="ValidateCollegeUser.php" onsubmit="return isLoginBlank()" method="post">                    		
                    			<div id="errorMsg">
                    				<?php
                        ...
                        <table border="0" width="50%">
                        	 <caption>College users only</caption>
                        	 <tr>
