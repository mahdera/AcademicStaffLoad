    ...
    <head>
        ...
        <style type="text/css">
		 ...
		 <script type="text/javascript" language="javascript">
		 	function showCourseReportForThisAcademicUnit(val)
		 	{
		 		//alert("10x to God! val is : "+val);
		 		if (val=="")
				  {
					  document.getElementById("courseReportDiv").innerHTML="";
					  return;
				  } 
				...
				xmlhttp.onreadystatechange=function()
				  {
					  ...
					  {
						  document.getElementById("courseReportDiv").innerHTML = xmlhttp.responseText;
					  }
				  }
				xmlhttp.open("GET","GetCollegeCourseReport.php?id="+val,true);
				xmlhttp.send();
		 	}//end function 
		 </script>
    </head>
...
?>
 <div id="wrap">
            ...
            <div id="indexmain">              
					...
					?>					
					<div>
						<select name="slctacademicunit" onChange="showCourseReportForThisAcademicUnit(this.value);">
					...
					<hr/>
					<div id="courseReportDiv">
						Course Report will be listed here
					</div>
