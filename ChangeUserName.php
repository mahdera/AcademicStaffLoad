...
?>
 <div id="wrap">
            ...
            <div id="indexmain">              
					...
					<form name="changeusername" method="post" action="UpdateUsername.php" onsubmit="return isUpdateBlank();">
						<table border="0" width="80%">
							...
							<tr>
								...
								<td>
									<input type="text" name="txtcurrentusername"/>
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<input type="text" name="txtnewusername"/>
								</td>
							</tr>
							<tr>
								<td>
