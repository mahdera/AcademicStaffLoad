 ...
 <div id="wrap">
            ...
            <div id="indexmain">              
					<?php
						...
						print("<caption>Academic Unit: $academicUnitName<br/>Full Timer Instructors</caption>");
								...
								if($ctr % 2 == 0)
							   {
								...
								else
								{
								  print("<tr style='background:#ecfdfe'>");
									...
									$positionName = AdminPosition::getPositionNameFor($resultInstructorsRow->other_responsibilities);
									print("<td align='center'><font size='2'>$positionName</font></td>");
								print("</tr>");
								$ctr++;
							}//end while loop
							//print("</table>");
