<html>
    <head>
        ...
        <script language="JavaScript" src="calendar-lang.js" type="text/JavaScript"></script> 
        <script language="JavaScript" src="calendar-setup.js" type="text/JavaScript"></script> 
            	...
            	?>  
					...
					<form name="frmaddinstructor" method="post" action="SaveInstructor.php" onsubmit="return isBlank();">
						...
						<table width="80%">
							...
							<tr>
								<td align="right">
									<font color="red">* </font>Instructor Id
								</td>
								<td align="left">
							...
							<tr>
								<td align="right">
									<font color="red">* </font>Qualification
								</td>
								<td align="left">
							...
							<tr>
								...
								<td align="left">
									<input type="text" name="txtemail" id="txtemail" onblur="checkAndChangeColor(this.value,id);" value="---"/>
								</td>								
							</tr>
							<tr>
								<td align="right">
								...
								<td align="left">
									<input type="text" name="txtmobilephone" id="txtmobilephone" onblur="checkAndChangeColor(this.value,id);" value="---"/>
								</td>								
							</tr>
							<tr>
								<td align="right">
									<font color="red">* </font>Academic Rank
								</td>
								<td align="left">
								<?php
							...
							<tr>
								<td align="right">
									<font color="red">* </font>Other Responsibilities
								</td>
								<td align="left">
									<?php
					...
					<div style="font-size:15">
							N.B: Fields marked with <font color="red">* </font> are mandatory!
						</div>
