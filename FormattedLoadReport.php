<?php
	/**
			THIS PHP FILE IS USED TO DISPLAY THE SEMESTER LOAD OF INSTRUCTORS IN A FORMATTED MANNER
			IT OTHERWISE, WILL NOT COMPUTE THE LOAD.
	*/
	...
	@session_start();
	$academicUnitId = $_SESSION['deptId'];//this is the current semester load	
