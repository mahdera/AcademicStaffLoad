    ...
    <head>
        ...
        <script language="javascript">
				...
				{	
					...
					xmlhttp.open("GET","GetCoursesInThisAcademicUnit.php?q="+str,true);
					xmlhttp.send();
				}
        </script>
    </head>
						...
						<table border="0" width="80%">
							<tr>								
								...
								<div>
									...
									-- Course Report <span id="loadspan" style="visibility:hidden;"> <img src="images/loadingfb.gif" width="16" height="16" align="absmiddle" border="0"/></span>
									</div>									 
								</td>					
							</tr>
						</table>
