            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
							   ...
							   if($ctr % 2 == 0)
							   {
								...
								else
								{
								  print("<tr style='background:#ecfdfe'>");
									...
									print("</td>");
									print("<td align='center'>");
										print("<a href='#.php' onclick='deleteThisTeachingCommitmentRateLookup($resultRow->id);'><img src='images/ImgDelete.gif' align='absmiddle' border='0'/></a>");
									print("</td>");
								print("</tr>");
								$ctr++;
							}//end while loop
						...
						print("</table>");						
						print("</div>");
						print("<div id='editCommitmentRateLookupDiv'></div>");
					?>
