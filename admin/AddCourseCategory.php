 ...
 <div id="wrap">
            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<form name="frmaddcoursecategory" method="post" action="SaveCourseCategory.php" onsubmit="return isBlank();">
						<br/><br/>
						
						<div id="errorMsg"></div>
						<table width="80%">
						<caption>Add New Course Category</caption>
							<tr>
								<td align="right">
									Course Category
								</td>
								<td align="left">
									<input type="text" name="txtcoursecategoryname" id="txtcoursecategoryname" onblur="checkAndChangeColor(this.value,id);"/>
								</td>								
							</tr>
							<tr>
								<td>
