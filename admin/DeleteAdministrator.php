						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("<td align='center'>");
								?>
									<a href="#.php" onclick="deleteThisAdministrator(<?php print($resultRow->id);?>);"><img src="images/deleteadmin.jpeg" align="absmiddle" border="0"/></a>
								<?php
								print("</td>");
							print("</tr>");
							$ctr++;
