<html>
    <head>
        ...
        <script language="javascript">
        		...
        		function confirmSemesterDeletion()
        		{
            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						print("<caption>List of Current Semester</caption>");
						print("<tr style='background: lightblue'>");
							print("<th><font size='2'>Semester</font></th>");							
							print("<th><font size='2'>Academic Year</font></th>");
								...
								else
								{
								  print("<tr style='background:#ecfdfe'>");
									...
									print("<td align='center'>");
										print("<font size='2'>$resultRow->semester</font>");
									print("</td>");
									print("<td align='center'>");
										print("<font size='2'>$resultRow->academic_year</font>");
									print("</td>");
									print("<td align='center'>");
										print("<font size='2'><a href='DeleteSemester.php?semester=$resultRow->semester&year=$resultRow->academic_year' onclick='return confirmSemesterDeletion();'><img src='images/ImgDelete.gif' border='0' align='absmiddle'/></a></font>");
									print("</td>");
								print("</tr>");
								$ctr++;
							}//end while loop
