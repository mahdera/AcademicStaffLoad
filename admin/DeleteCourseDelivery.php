<html>
    <head>
        ...
        <script language="javascript">
        		...
        		function confirmDeleteCourseDelivery()
        		{
        			if(window.confirm('Are you sure you want to delete this course delivery?'))
        				return true;
        			else
        				return false;
        		}
            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						print("<caption>Delete Course Delivery</caption>");
						print("<tr style='background: lightblue'>");
							print("<th><font size='2'>Id</font></th>");							
							print("<th><font size='2'>Course Delivery</font></th>");
						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("</td>");
								print("<td align='center'>");
									print("<font size='2'>$resultRow->course_delivery_name</font>");
								print("</td>");
								print("<td align='center'>");
									print("<a href='DeleteThisCourseDelivery.php?id=$resultRow->id' onclick='return confirmDeleteCourseDelivery();'><img src='images/ImgDelete.gif' align='absmiddle' border='0'/></a>");
								print("</td>");
							print("</tr>");
							$ctr++;
						}//end while loop
