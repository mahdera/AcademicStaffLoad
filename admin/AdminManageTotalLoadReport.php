        ...
        <script type="text/javascript" language="javascript">
		 	function showLoadReportForThisAcademicUnit(academicUnitId,academicYear,semester)
		 	{
		 		...
		 		else
		 		{
					...
					xmlhttp.open("GET","GetCollegeTotalLoadReport.php?academicUnitId="+academicUnitId+"&academicYear="+academicYear+"&semesterP="+semester,true);
					xmlhttp.send();
				}//end else
		 	}//end function 
		 </script>
...
?>
 <div id="wrap">
            ...
            <?php
            	...
            	include_once('AdminTotalLoadReportInnerMenu.inc');
