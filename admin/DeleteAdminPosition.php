<html>
    <head>
        ...
        <script language="javascript">
        		...
        		function confirmAdminPositionDeletion()
        		{
	        		if(window.confirm('Are you sure you want to delete this admin position?'))
	        			return true;
	        		else
	        			return false;
        		}
            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						print("<caption>Delete Admin Position</caption>");
						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("</td>");
								print("<td align='center'>");
									print("<a href='DeleteThisAdminPosition.php?id=$resultRow->id' onclick='return confirmAdminPositionDeletion();'><img src='images/ImgDelete.gif' align='absmiddle' border='0'/></a>");
								print("</td>");
							print("</tr>");
							$ctr++;
						}//end while loop
