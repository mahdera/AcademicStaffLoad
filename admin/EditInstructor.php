    ...
    <head>
        ...
        <script language="javascript">
				...
				{	
					...
					xmlhttp.open("GET","GetInstructorsInThisAcademicUnitForEdit.php?q="+str,true);
					xmlhttp.send();
				}
        </script>
    </head>
            ...
            <div id="indexmain"> 
            	...
            	<div>
						...
						<table border="0" width="80%">
							<tr>								
								<td>
									...
									-- Edit Instructor <span id="loadspan" style="visibility:hidden;"> <img src="images/loadingfb.gif" width="16" height="16" align="absmiddle" border="0"/></span>									 
								</td>					
							</tr>
						</table>
					</div>
					...
					<div id="instructorProfile">
						<b>Instructor information will be displayed here</b><br/>
					</div>             	           
