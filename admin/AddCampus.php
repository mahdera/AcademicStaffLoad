 ...
 <div id="wrap">
            ...
            <div id="indexmain"> 
            	...
            	?>  
                        ...
                        <form name="frmaddcampus" method="post" action="SaveCampus.php" onsubmit="return isBlank();">
                                <br/><br/>                                
                                <div id="errorMsg"></div>                                
                                <table width="80%">
                                    <caption>Add New Campus</caption>
                                        <tr>
                                                <td align="right">
                                                    Campus Id
                                                </td>
                                                <td align="left">
                                                    <input type="text" name="txtcampusid" id="txtcampusid"/>
                                                </td>
                                        </tr>
                                        <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                        <input type="text" name="txtcampusname" id="txtcampusname" onblur="checkAndChangeColor(this.value,id);"/>
                                                </td>
                                        </tr>
                                        <tr>
                                                <td>
