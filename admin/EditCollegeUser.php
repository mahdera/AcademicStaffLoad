						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("<td align='center'>");
								?>
									<a href="#.php" onclick="showCollegeUserEditFields(<?php print($resultRow->instructor_id);?>);"><img src="images/edit.gif" align="absmiddle" border="0"/></a>
								<?php
								print("</td>");
							print("</tr>");
							$ctr++;
