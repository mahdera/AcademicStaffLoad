<html>
    <head>
        ...
        <script language="javascript">
        		...
        		function confirmFacultyDeletion()
        		{
            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						print("<caption>Delete Faculty/Institute</caption>");
						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("</td>");
								print("<td align='center'>");
									print("<a href='DeleteThisFaculty.php?id=$resultRow->id' onclick='return confirmFacultyDeletion();'><img src='images/ImgDelete.gif' align='absmiddle' border='0'/></a>");
								print("</td>");
							print("</tr>");
							$ctr++;
						}//end while loop
