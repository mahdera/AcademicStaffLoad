            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						print("<caption>Delete Course Category</caption>");
						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("</td>");
								print("<td align='center'>");
									print("<a href='DeleteThisCourseCategory.php?id=$resultRow->id' onclick='return confirmCourseCategoryDeletion();'><img src='images/ImgDelete.gif' align='absmiddle' border='0'/></a>");
								print("</td>");
							print("</tr>");
							$ctr++;
						}//end while loop
