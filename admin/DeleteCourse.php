    ...
    <head>
        ...
        <script language="javascript">
        		function showCourses(str)
				{
					...
					xmlhttp.open("GET","GetCoursesInThisAcademicUnitForDelete.php?q="+str,true);
					xmlhttp.send();
				}
				
				function confirmCourseDeletion(courseNumber)
				{
					if(window.confirm('Are you sure you want to delete course : '+courseNumber+' ?'))
						return true;
					else
						return false;
				}
						...
						<table border="0" width="80%">
							<tr>								
								<td>
									...
									-- Delete Course <span id="loadspan" style="visibility:hidden;"> <img src="images/loadingfb.gif" width="16" height="16" align="absmiddle" border="0"/></span>								 
								</td>					
							</tr>
						</table>
					</div>
