            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						print("<caption>List of Users</caption>");
						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("<td align='center'>");
								?>
									<a href="#.php" onclick="deleteThisCollegeUser(<?php print($resultRow->instructor_id);?>);"><img src="images/delete_college_user.jpeg" align="absmiddle" border="0"/></a>
								<?php
								print("</td>");
							print("</tr>");
							$ctr++;
						...
						print("</div>");
						print("<hr/>");
						print("<div id='collegeUserEditDiv'></div>");
						print("</form>");						
					?>					
