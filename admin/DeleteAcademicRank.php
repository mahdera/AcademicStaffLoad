<html>
    <head>
        ...
        <script language="javascript">
        		...
        		function confirmAcademicRankDeletion()
        		{
        			if(window.confirm('Are you sure you want to delete this academic rank?'))
        				return true;
        			else
        				return false;
        		}
            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						print("<caption>Delete Academic Rank</caption>");
							   ...
							   if($ctr % 2 == 0)
							   {
								...
								else
								{
								  print("<tr style='background:#ecfdfe'>");
									...
									print("</td>");									
									print("<td align='center'>");
										print("<a href='DeleteThisAcademicRank.php?rankId=$resultRow->id' onclick='return confirmAcademicRankDeletion();'><img src='images/ImgDelete.gif' align='absmiddle' border='0'/></a>");
									print("</td>");
								print("</tr>");
								$ctr++;
							}//end while loop
