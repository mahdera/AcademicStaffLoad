 ...
 <div id="wrap">
            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<form name="frmadduser" method="post" action="SaveCollegeUser.php" onsubmit="return isBlank();">
						<br/><br/>
						
						<div id="errorMsg"></div>
						<table width="80%">
						<caption>Add New College User</caption>
							<tr>
								<td align="right">
									Select Faculty
								</td>
								<td align="left">
									<select name="slctfaculty" id="slctfaculty" onchange="checkAndChangeColor(this.value,id);">
