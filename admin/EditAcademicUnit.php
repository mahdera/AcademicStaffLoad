            ...
            <div id="indexmain"> 
            	...
            	?>  
					...
					<?php
						...
						$query = "SELECT * FROM  tblFaculty,tblAcademicUnit WHERE tblFaculty.id = tblAcademicUnit.faculty_id ORDER BY faculty_name, academic_unit_name ASC";
						$result = DBConnection::readFromDatabase($query);
						$ctr = 1;						
						print("<div align='center'></div>");					
						
						print("<table width='80%' align='center'>");
						print("<caption>Edit Academic Unit</caption>");
						   ...
						   if($ctr % 2 == 0)
						   {
							...
							else
							{
							  print("<tr style='background:#ecfdfe'>");
								...
								print("<td align='center'>");
									print("<a href='EditThisAcademicUnit.php?id=$resultRow->id'><img src='images/edit.gif' align='absmiddle' border='0'/></a>");
								print("</td>");
							print("</tr>");
							$ctr++;
						}//end while loop
