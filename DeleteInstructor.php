<html>
    <head>
        ...
        <script language="javascript">
				...
				function confirmInstructorDeletion(instructorId)
				{
					if(window.confirm('Are you sure you want to delete instructor with id : '+instructorId+' ?'))
						return true;
					else
						return false;
				}
...
?>
 <div id="wrap">
            ...
            <div id="indexmain"> 
            	...
            	<?php
            		include('GetInstructorsInThisAcademicUnitForDelete.php');
            	?>
