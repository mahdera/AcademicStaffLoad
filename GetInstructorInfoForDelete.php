		...
		print("<table width='100%' border='0'>");
			print("<tr style='background:lightblue'>");
				...
				{					
					...
					print("<th><font size='2'>Delete</font></th>");				
				}		
			...
			while($resultLoadRow = mysql_fetch_object($resultLoad))
			{
			   ...
			   {
			     $rowId = "tr".$ctr;
				  print("<tr style='background:#ded7fe' id='$rowId'>");
				}
				else
				{
				  $rowId = "tr".$ctr;
				  print("<tr style='background:#ecfdfe' id='$rowId'>");
				}				
					print("<td>");
						//print("here");
					...
					print("<td align='center'>");
						...
						print("<a id='$courseNumber' href='DeleteThisLoadInfo.php?instructorId=$instructorId&courseNumber=$courseNumber&type=$type' onclick='return confirmLoadDeletion(this.id);'><img src='images/ImgDelete.gif' border='0' align='absmiddle' title='Delete: $courseTitle'/></a>");
					print("</td>");
				print("</tr>");
				$ctr++;
			}
				...
				else
				{
				  print("<tr style='background:#ecfdfe'>");
					...
					print("<td align='center'>");
						...
						print("<input type='hidden' id='$courseTitleControlName' value='$courseTitle'/>");
						//print("<input type='hidden' id);
						print("<a href='DeleteThisLoadInfo.php?instructorId=$instructorId&courseNumber=$courseNumber&type=$type'><img src='images/ImgDelete.gif' border='0' align='absmiddle'/></a>");
					print("</td>");
				print("</tr>");
				$ctr++;
			}
